#!/usr/bin/env python3
"""Scaffold for factory/factory_worker.py."""
...
SCRIPT_NAME = "factory/factory_worker.py"
...
def main() -> int:
    log_to_system_logs(f"{SCRIPT_NAME}:start", related_entity="factory-worker")
    # TODO: implement factory-worker logic for RUNTIME_PROTOCOL_V2.
    return 0
