#!/usr/bin/env python3
"""Scaffold for scripts/build_module_index.py."""
...
SCRIPT_NAME = "scripts/build_module_index.py"
...
def main() -> int:
    log_to_system_logs(f"{SCRIPT_NAME}:start", related_entity="module-index-builder")
    # TODO: implement module-index-builder logic for RUNTIME_PROTOCOL_V2.
    return 0
